-- // Sakura Hub 🌸 \\ -- | (Version 1.31) [ Made by ThroughTheFireAndFlames#9925 :3 ]
...
local function switchToStand(standName)
    ...
    local lplayer = game.Players.LocalPlayer
    for i = 1, 100 do
        local slotText = lplayer.PlayerGui.StandStorage.Outer.Inner.Inner["Slot"..i].Text.Text
        if slotText == standName then
            local args = {"Slot"..i}
            if i <= 6 then
                rs.StorageRemote["Slot"..i]:FireServer()
            else
                rs.StorageRemote.UseStorageExtra:FireServer(unpack(args))
            end
            return
        end
    end
...
getgenv().UsingDekuAutofarm1 = function()
    ...
    -- Accept and claim quests
    task.spawn(function()
        while getgenv().AutofarmOnDeku1 do
            pcall(function()
                local args = {33}
                rs:WaitForChild("QuestRemotes"):WaitForChild("AcceptQuest"):FireServer(unpack(args))
                rs:WaitForChild("QuestRemotes"):WaitForChild("ClaimQuest"):FireServer(unpack(args))
            end)
            task.wait(0.35)
        end
    end)

    -- Handle item purchasing and selling
    task.spawn(function()
        while getgenv().AutofarmOnDeku1 do
            pcall(function()
                local backpack = lplayer:WaitForChild("Backpack")
                if lplayer.Data.Mastery.Value < 3 and lplayer.Data.Cash.Value > 75 then
                    rs:WaitForChild("BuyItemRemote"):WaitForChild("Rokakaka"):FireServer("99")
                end
                ...
                for _, item in ipairs(backpack:GetChildren()) do
                    if table.find({
                        ...
                        rs:WaitForChild("GlobalUsedRemotes"):WaitForChild("SellItem"):FireServer(item.Name)
                    end
                end
        ...
        while getgenv().AutofarmOnDeku1 do
            pcall(function()
                for _, enemy in pairs(workspace.Living:GetChildren()) do
                    if table.find({
                        "Bygone", "Angelica", "AngelicaWeak", "BlackSilence"
                    }, enemy.Name) and enemy:FindFirstChild("Humanoid") then
    ...
    -- Handle Roland and Deku
    task.spawn(function()
        while getgenv().AutofarmOnDeku1 do
            pcall(function()
                local roland = workspace.Living:FindFirstChild("Roland")
                local animeking221 = workspace.Living:FindFirstChild("animeking221")
                local iceIsNlCE = workspace.Living:FindFirstChild("IceIsNlCE")

                if roland then
                    local animekingParticipated = animeking221 and roland:FindFirstChild("Participated") and roland.Participated:FindFirstChild("animeking221")
                    local iceIsNlCEParticipated = iceIsNlCE and roland:FindFirstChild("Participated") and roland.Participated:FindFirstChild("IceIsNlCE")

                    local shouldAttack = animeking221 and iceIsNlCE and animekingParticipated and iceIsNlCEParticipated
                                    or not animeking221 and not iceIsNlCE
                                    or animekingParticipated or iceIsNlCEParticipated

                    if shouldAttack and not workspace.Item2:FindFirstChild("OA's Grace") and lplayer.Data.StandName.Value == "Shinra Kusakabe" then
                        if lplayer.Character.Humanoid.Health ~= 0 then
                            ...
                            local rolandBoss = roland:FindFirstChild("HumanoidRootPart")
                            teleportToPosition(rolandBoss.Position - rolandBoss.CFrame.lookVector * 7)
    ...
    task.spawn(function()
        while getgenv().AutofarmOnDeku1 do
            pcall(function()
                ...
                if deku and not workspace.Item2:FindFirstChild("OA's Grace") and not lplayer.Backpack:FindFirstChild("OA's Grace") and lplayer.Data.StandName.Value == "Shinra Kusakabe" then
                    if lplayer.Character.Humanoid.Health ~= 0 and not deku.CDValues:FindFirstChild("Blocking") then
                        local dekuHumanoid = deku.Humanoid
                        if dekuHumanoid and dekuHumanoid.Health ~= dekuHumanoid.MaxHealth then
                            task.spawn(function()
                                dekuHumanoid.Health = 0
                            end)
                        end
                        local dekuBoss = deku:FindFirstChild("HumanoidRootPart")
                        teleportToPosition(dekuBoss.Position - dekuBoss.CFrame.lookVector * 7)
                        rs:WaitForChild("ShinraRemote"):WaitForChild("Ignition"):FireServer()
                        rs:WaitForChild("ShinraRemote"):WaitForChild("Punch"):FireServer()
                        rs:WaitForChild("ShinraRemote"):WaitForChild("Fierce"):FireServer()
                        rs:WaitForChild("ShinraRemote"):WaitForChild("Corna"):FireServer()
    ...
    -- Switch to OA Stage 4 if conditions are met
    task.spawn(function()
        while getgenv().AutofarmOnDeku1 do
            pcall(function()
                local hasOAsGrace = lplayer.Backpack:FindFirstChild("OA's Grace")
                if not workspace.Living:FindFirstChild("Deku") and not workspace.Living:FindFirstChild("Roland") and not hasOAsGrace and lplayer.Data.StandName.Value == "Shinra Kusakabe" then
    ...
    -- Switch to Shinra Kusakabe if conditions are met
    task.spawn(function()
        while getgenv().AutofarmOnDeku1 do
            pcall(function()
                local deku = workspace.Living:FindFirstChild("Deku")
                local hasOAsGrace = lplayer.Backpack:FindFirstChild("OA's Grace")
                if deku and not hasOAsGrace and not lplayer.PlayerGui.InCombat.Enabled and lplayer.Data.StandName.Value == "OA [Stage 4]" then
...
AreasTab.newButton("Shop","",function()
    pcall(function()
        getgenv().PlaySound();game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-375.9766845703125,-31.704181671142578,1810.9178466796875);
    end)
end)

AreasTab.newButton("Cafe","",function()
    pcall(function()
        getgenv().PlaySound();game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-237.51318359375,-32.0684814453125,1452.0396728515625);
    end)
end)

AreasTab.newButton("Main Park","",function()
    pcall(function()
        getgenv().PlaySound();game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-537.5374145507812,-32.051334381103516,1419.20361328125);
    end)
end)

AreasTab.newButton("Side Park","",function()
    pcall(function()
        getgenv().PlaySound();game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-73.15850830078125,-32.01318359375,1636.9390869140625);
    end)
end)

AreasTab.newButton("Hueco Mundo","",function()
    pcall(function()
        getgenv().PlaySound();game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-9330.2342364238,428.23523576,1725.2305236759535);
    end)
end)

AreasTab.newButton("Alley","",function()
    pcall(function()
        getgenv().PlaySound();game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-596.9303588867188,-33.014976501464844,1894.4188232421875);
    end)
end)
...
AreasTab.newButton("Bird","",function()
    pcall(function()
        if game:GetService("Workspace").Effects:FindFirstChild("Bird") then
            ...
            BoredLibrary.prompt("Sakura Hub   🌸","The bird is not here :(",1);
        end
    end)
end)
...
AreasTab.newButton("Sakura Office","",function()
    pcall(function()
        getgenv().PlaySound();game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-637.9895629882812,4.135000228881836,-325.9488830566406);
    end)
end)

AreasTab.newButton("Sakura Tree","",function()
    pcall(function()
        getgenv().PlaySound();game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-515.90966796875,-32.15133285522461,1426.1767578125);
    end)
end)

AreasTab.newButton("The Forest","",function()
    pcall(function()
        getgenv().PlaySound();game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-531.663330078125,-32.643638610839844,1175.7890625);
    end)
end)

AreasTab.newButton("Battle Field","",function()
    pcall(function()
        getgenv().PlaySound();game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-520.662841796875,-31.358125686645508,1584.3505859375);
    end)
end)

AreasTab.newButton("Library","",function()
    pcall(function()
        getgenv().PlaySound();game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-50.88117599487305,-116.3696060180664,344.53594970703125);
    end)
end)

AreasTab.newButton("Ruined City","",function()
    pcall(function()
        getgenv().PlaySound();game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-7150.1806640625,-32.022640228271484,1294.813720703125);
    end)
end)

AreasTab.newButton("White Room","",function()
    pcall(function()
        getgenv().PlaySound();game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-30.787561416625977,-2.1192715167999268,1510.0244140625);
    end)
end)

AreasTab.newButton("Midknight Arena","",function()
    pcall(function()
        getgenv().PlaySound();game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(8901.267578125,-371.0782165527344,-7650.62939453125);
    end)
end)

AreasTab.newButton("PvP Arena","",function()
    pcall(function()
        getgenv().PlaySound();game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(855.4273071289062,-395.0755920410156,-749.8252563476562);
    end)
end)

AreasTab.newButton("Anubis Dimension","",function()
    pcall(function()
        getgenv().PlaySound();game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(3505.6298828125,-399.08502197265625,1144.2833251953125);
    end)
end)

AreasTab.newButton("Testing Place","",function()
    pcall(function()
        getgenv().PlaySound();game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(2383.890625,-429.52105712890625,3179.1923828125);
    end)
end)

AreasTab.newButton("Espada Place","",function()
    pcall(function()
        getgenv().PlaySound();game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(612.9273681640625,-6.123868465423584,1690.8900146484375);
    end)
end)

AreasTab.newButton("Sanity Room","",function()
    pcall(function()
        getgenv().PlaySound();game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(3487.05322265625,-374.0752868652344,484.3776550292969);
    end)
end)

AreasTab.newButton("Sukuna Domain","",function()
    pcall(function()
        getgenv().PlaySound();game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(7186.9072265625,-140,3946.327880859375);
    end)
end)
...
AreasTab.newButton("Depths","",function()
    pcall(function()
        getgenv().PlaySound();game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(7444.07763671875,-427.5655212402344,-4017.9833984375);
    end)
end)

AreasTab.newButton("Cave","",function()
    pcall(function()
        getgenv().PlaySound();game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-2343.34326171875,-393.6280822753906,-5044.39013671875);
    end)
end)

AreasTab.newButton("Holy Grail War","",function()
    pcall(function()
        getgenv().PlaySound();game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(3932.30126953125,-234.16961669921875,4539.80810546875);
    end)
end)

AreasTab.newButton("EthrixLame","",function()
    pcall(function()
        getgenv().PlaySound();game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-2036.6947021484375,-386.40875244140625,-5355.85888671875);
    end)
end)

AreasTab.newButton("Highest Peak","",function()
    pcall(function()
        getgenv().PlaySound();game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-2122.210693359375,-113.98542022705078,-4635.59130859375);
    end)
end)
