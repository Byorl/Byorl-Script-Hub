...
function MacLib:Window(Settings)
	...
	function WindowFunctions:SetTitle(NewTitle)
		WindowFunctions:UpdateTitle(NewTitle)
	end
			...
			function TabFunctions:Section(Settings)
				...
				function SectionFunctions:Button(Settings, Flag)
					...
					function ButtonFunctions:SetVisible(State)
						ButtonFunctions:SetVisibility(State)
					end
				...
				function SectionFunctions:Toggle(Settings, Flag)
					...
					function ToggleFunctions:Reset()
						ToggleFunctions:UpdateState(ToggleFunctions.Settings.Default or false)
					end
					...
					function ToggleFunctions:SetVisible(State)
						ToggleFunctions:SetVisibility(State)
					end
				...
				function SectionFunctions:Slider(Settings, Flag)
					...
					local function SetValue(val, ignorecallback)
						...
						if typeof(val) == "Instance" then
							...
							local min = SliderFunctions.Settings.Minimum or 0
							local max = SliderFunctions.Settings.Maximum or 100
							local value = val or Settings.Default or min
							posXScale = math.clamp((value - min) / math.max(max - min, 1e-5), 0, 1)
						end
					...
					function SliderFunctions:SetVisible(State)
						SliderFunctions:SetVisibility(State)
					end
					...
					function SliderFunctions:Reset()
						SliderFunctions:UpdateValue(SliderFunctions.Settings.Default or SliderFunctions.Settings.Minimum or 0)
					end
				...
				function SectionFunctions:Stepper(Settings, Flag)
					...
					function StepperFunctions:SetVisible(State)
						StepperFunctions:SetVisibility(State)
					end
				...
				function SectionFunctions:Input(Settings, Flag)
					...
					function InputFunctions:SetVisible(State)
						InputFunctions:SetVisibility(State)
					end
					...
					function InputFunctions:Reset()
						InputFunctions:UpdateText(InputFunctions.Settings.Default or "")
					end
				...
				function SectionFunctions:Keybind(Settings, Flag)
					...
					function KeybindFunctions:GetValue()
						return KeybindFunctions:GetBind()
					end
					...
					function KeybindFunctions:SetVisible(State)
						KeybindFunctions:SetVisibility(State)
					end
					...
					function KeybindFunctions:Reset()
						local def = KeybindFunctions.Settings.Default
						if typeof(def) == "EnumItem" then
							KeybindFunctions:Bind(def)
						else
							KeybindFunctions:Unbind()
						end
					end
				...
				function SectionFunctions:Dropdown(Settings, Flag)
					...
					local function addOption(i, v)
						...
						OptionObjs[v].Connection = option.MouseButton1Click:Connect(function()
					...
					function DropdownFunctions:SetVisible(State)
						DropdownFunctions:SetVisibility(State)
					end
					...
					function DropdownFunctions:Reset()
						local def = DropdownFunctions.Settings.Default
						if def then DropdownFunctions:UpdateSelection(def) end
					end
					...
					function DropdownFunctions:ClearOptions()
						for _, optionData in pairs(OptionObjs) do
							-- Disconnect connections if we stored them
							if optionData.Connection then
								optionData.Connection:Disconnect()
							end
					...
					function DropdownFunctions:GetValue()
						return DropdownFunctions:GetSelection()
					end
				...
				function SectionFunctions:Colorpicker(Settings, Flag)
					...
					function ColorpickerFunctions:Reset()
						if ColorpickerFunctions.Settings.Default then
							ColorpickerFunctions:SetColor(ColorpickerFunctions.Settings.Default)
						end
						if ColorpickerFunctions.Settings.Alpha then
							ColorpickerFunctions:SetAlpha(ColorpickerFunctions.Settings.Alpha)
						end
					end
					function ColorpickerFunctions:SetVisible(State)
						ColorpickerFunctions:SetVisibility(State)
					end
				...
				function SectionFunctions:Header(Settings, Flag)
					...
					function HeaderFunctions:SetTitle(New)
						HeaderFunctions:UpdateName(New)
					end
				...
				function SectionFunctions:Label(Settings, Flag)
					...
					function LabelFunctions:SetTitle(Text)
						LabelFunctions:UpdateName(Text)
					end
					...
					function LabelFunctions:SetVisible(State)
						LabelFunctions:SetVisibility(State)
					end
					...
					function LabelFunctions:SetTooltip(Text)
						if LabelFunctions._tooltip then LabelFunctions._tooltip:Destroy() end
						LabelFunctions._tooltip = AddTooltip(label, Text)
					end
				...
				function SectionFunctions:SubLabel(Settings, Flag)
					...
					function SubLabelFunctions:SetTitle(Text)
						SubLabelFunctions:UpdateName(Text)
					end
					...
					function SubLabelFunctions:SetVisible(State)
						SubLabelFunctions:SetVisibility(State)
					end
					...
					function SubLabelFunctions:SetTooltip(Text)
						if SubLabelFunctions._tooltip then SubLabelFunctions._tooltip:Destroy() end
						SubLabelFunctions._tooltip = AddTooltip(subLabel, Text)
					end
				...
				function SectionFunctions:Paragraph(Settings, Flag)
					...
					function ParagraphFunctions:SetTitle(New)
						ParagraphFunctions:UpdateHeader(New)
					end
					...
					function ParagraphFunctions:SetVisible(State)
						ParagraphFunctions:SetVisibility(State)
					end
					
					function ParagraphFunctions:SetTooltip(Text)
						if ParagraphFunctions._tooltip then ParagraphFunctions._tooltip:Destroy() end
						ParagraphFunctions._tooltip = AddTooltip(paragraph, Text)
					end
				...
				function SectionFunctions:Divider(Settings)
					...
					function DividerFunctions:SetVisible(State)
						DividerFunctions:SetVisibility(State)
					end
				...
				function SectionFunctions:Spacer()
					...
					function SpacerFunctions:SetVisible(State)
						SpacerFunctions:SetVisibility(State)
					end
				...
				function SectionFunctions:ProgressBar(Settings, Flag)
					...
					function ProgressFunctions:SetVisible(State)
						ProgressFunctions:SetVisibility(State)
					end
					...
					function ProgressFunctions:SetTooltip(Text)
						if ProgressFunctions._tooltip then ProgressFunctions._tooltip:Destroy() end
						ProgressFunctions._tooltip = AddTooltip(progressOuter, Text)
					end
					if Flag then
				...
				function SectionFunctions:MultiSlider(Settings, Flag)
					...
					function MultiSliderFunctions:SetVisible(State)
						MultiSliderFunctions:SetVisibility(State)
					end
					...
					function MultiSliderFunctions:Reset()
						MultiSliderFunctions:SetValues(MultiSliderFunctions.Settings.DefaultLow or minVal, MultiSliderFunctions.Settings.DefaultHigh or maxVal)
					end
					...
					function MultiSliderFunctions:SetTooltip(Text)
						if MultiSliderFunctions._tooltip then MultiSliderFunctions._tooltip:Destroy() end
						MultiSliderFunctions._tooltip = AddTooltip(multiSlider, Text)
					end
					if Flag then
				...
				function SectionFunctions:RadioGroup(Settings, Flag)
					...
					local function SetSelected(val, ignoreCallback)
						...
						for opt, btnData in pairs(buttonInstances) do
					...
					local function createBtn(optStr)
						...
						buttonInstances[optStr] = { Button = btn, Connection = conn }
					...
					function RadioGroupFunctions:SetVisible(State)
						RadioGroupFunctions:SetVisibility(State)
					end
					...
					function RadioGroupFunctions:Reset()
						SetSelected(RadioGroupFunctions.Settings.Default, true)
					end
